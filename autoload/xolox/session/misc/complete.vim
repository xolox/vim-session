...
function! xolox#session#misc#complete#keywords(arglead, cmdline, cursorpos)
  ...
  "
  "     :command -nargs=* -complete=customlist,xolox#session#misc#complete#keywords MyCmd call s:MyCmd(<f-args>)
  let words = {}
