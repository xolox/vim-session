...
function! xolox#session#misc#escape#pattern(string) " {{{1
...
function! xolox#session#misc#escape#substitute(string) " {{{1
  " Takes a single string argument and converts it into a [:substitute]
...
function! xolox#session#misc#escape#shell(string) " {{{1
